...
;;(defun make-docbook-key-bindings ()
;;)
...
(defun docbook-xml-insert-emphasis ()
  ...
  (interactive)
  (docbook-xml-insert-tag-single "<emphasis>" "</emphasis>"))
  ;; (insert "<emphasis></emphasis>")
  ;; (backward-char 11))

(defun docbook-xml-insert-tag-single (start-tag end-tag)
  (interactive)
  (insert start-tag)
  (insert end-tag)
...
(defun docbook-xml-insert-para ()
  ...
  (interactive)
  (docbook-xml-insert-tag-single "<para>" "</para>"))
  ;; (insert "<para>")
  ;; (docbook-xml-indent-current-line)
...
(defun docbook-xml-insert-replaceable ()
  "Inserts a new PARA element.  Leaves point inside the element."
  (interactive)
  (docbook-xml-insert-tag-single "<replaceable>" "</replaceable>"))

(defun docbook-xml-insert-ipython ()
  "Inserts a new PARA element.  Leaves point inside the element."
  (interactive)
  (docbook-xml-insert-tag-single "<programlisting>#! ipython\n"
								 "</programlisting>"))

(defun docbook-xml-insert-programlisting ()
  "Inserts a new PARA element.  Leaves point inside the element."
  (interactive)
  (docbook-xml-insert-tag-single "<programlisting>" "</programlisting>"))

(defun docbook-xml-insert-literal ()
  "Inserts a new PARA element.  Leaves point inside the element."
  (interactive)
  (docbook-xml-insert-tag-single "<literal>" "</literal>"))

(defun docbook-xml-insert-itemizedlist ()
  "Inserts a new itemized list.  Leaves point inside the element."
  (interactive)
  (docbook-xml-insert-tag "<itemizedlist>" "</itemizedlist>"))

(defun docbook-xml-insert-listitem ()
  "Inserts a new itemized list.  Leaves point inside the element."
  (interactive)
  (docbook-xml-insert-tag "<listitem>" "</listitem>")
  (docbook-xml-insert-para))

(defun docbook-xml-insert-tag (start-tag end-tag)
  (interactive)
  (insert start-tag)
  (docbook-xml-indent-current-line)
  (let ((indentation (current-indentation))
