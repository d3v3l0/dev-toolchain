...
export ARROW_BUILD_ZLIB=ON
export ARROW_BUILD_SNAPPY=ON
export ARROW_BUILD_LZ4=ON
export ARROW_BUILD_ZSTD=ON
export ARROW_BUILD_BROTLI=ON
export ARROW_BUILD_BZ2=ON
export ARROW_BUILD_ZSTD=ON
export ARROW_BUILD_DATASET=ON
export ARROW_BUILD_EXAMPLES=ON
...
export ARROW_BUILD_PARQUET_ENCRYPTION=ON
export ARROW_BUILD_PLASMA=OFF
export ARROW_BUILD_PYTHON=ON
export ARROW_BUILD_SHARED=ON
export ARROW_BUILD_STATIC=ON
export ARROW_LARGE_MEMORY_TESTS=ON
export ARROW_TEST_LINKAGE=shared
export ARROW_GANDIVA_BUILD_TESTS=OFF
...
-DARROW_LARGE_MEMORY_TESTS=$ARROW_LARGE_MEMORY_TESTS \
-DARROW_WITH_ZLIB=$ARROW_BUILD_ZLIB \
-DARROW_WITH_LZ4=$ARROW_BUILD_LZ4 \
-DARROW_WITH_SNAPPY=$ARROW_BUILD_SNAPPY \
-DARROW_WITH_BROTLI=$ARROW_BUILD_BROTLI \
...
-DARROW_TEST_LINKAGE=$ARROW_TEST_LINKAGE \
-DARROW_BUILD_EXAMPLES=$ARROW_BUILD_EXAMPLES \
-DARROW_BUILD_TESTS=$ARROW_BUILD_TESTS \
-DARROW_DATASET=$ARROW_BUILD_DATASET \
...
-DPARQUET_REQUIRE_ENCRYPTION=$ARROW_BUILD_PARQUET_ENCRYPTION \
